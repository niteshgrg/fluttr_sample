...
import 'package:flutter_todos/blocs/widget_bloc/widget_bloc.dart';
...
class TodosBloc extends WidgetBloc {
  ...
  @override
  Stream<TodosState> mapEventToState(WidgetEvents event) async* {
    super.add(event);
